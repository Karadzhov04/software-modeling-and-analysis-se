...
| :--- | :--- | :--- |
| Целта на системата е да дигитализира процеса на поръчка на храна, като свърже клиенти и ресторанти чрез централизирана платформа. Системата улеснява: 
1.Клиентите – за бързо и удобно поръчване на храна.
2.Собствениците на ресторанти – за лесно управление на менюто и поръчките.
3.Администраторите – за контрол и наблюдение на цялата екосистема.| *Кой ще използва продукта?* | *Какво ще бъде създадено?* |

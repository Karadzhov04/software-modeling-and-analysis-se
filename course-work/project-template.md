...
| :--- | :--- | :--- |
| Целта на системата е да дигитализира процеса на поръчка на храна, като свърже клиенти и ресторанти чрез централизирана платформа. Системата улеснява клиентите чрез бързо и удобно поръчване на храна, собствениците на ресторанти чрез лесно управление на менюто и поръчките, и администраторите чрез контрол и наблюдение на цялата екосистема.| *Кой ще използва продукта?* | *Какво ще бъде създадено?* |
